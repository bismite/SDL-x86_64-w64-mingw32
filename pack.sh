...
for dll in libSDL2main.a libSDL2.dll.a; do
  cp -R ${SDL2}/x86_64-w64-mingw32/lib/${dll} ${DIR}/lib/
done
...
for dll in SDL2_mixer.dll libmpg123-0.dll; do
  cp -R ${SDL2_MIXER}/x86_64-w64-mingw32/bin/${dll} ${DIR}/bin/
done
...
for dll in SDL2_image.dll libpng16-16.dll zlib1.dll; do
  cp -R ${SDL2_IMAGE}/x86_64-w64-mingw32/bin/${dll} ${DIR}/bin/
done
